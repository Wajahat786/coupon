...
<article class="detail">
  <a class="back-link" href="/coupons">← Back to coupons</a>
  ...
  <div class="reveal-box">
    <div class="code-row code-row-lg">
      ...
      <button class="btn btn-copy" type="button" data-copy="<?= e($coupon['code']) ?>">📋 Copy Code</button>
    </div>
    <?php if (!empty($coupon['link'])): ?>
      <a class="btn btn-primary btn-lg" href="/go/coupon/<?= (int) $coupon['id'] ?>" target="_blank" rel="noopener nofollow ugc">
        Activate Deal at <?= e($coupon['store_name']) ?> →
      </a>
    <?php endif; ?>
  </div>
